...
Noto Sans Regular and Bold are from the official notofonts/noto-fonts repository:
...
The browser and FFmpeg use these same two font files. Hashes pin the actual
